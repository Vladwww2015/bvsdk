...
>>>>>>> d13f581 (Tmp)
        ...
        $salesOrderDetail['REQUIRED_DATE'] = self::generateRandomString(8);
        $salesOrderDetail['SHIPPED_DATE'] = self::generateRandomString(8);
...
>>>>>>> d13f581 (Tmp)
    ...
    public static function generateFakeDataOrderAddress()
    {
        ...
        $orderAddress['BVRVVERSION'] = self::generateRandomNumber(4);
        $orderAddress['BVRVMODDATE'] = self::generateRandomString(8);
        $orderAddress['BVRVMODTIME'] = self::generateRandomNumber(8);
        $orderAddress['BVRVUSERINIT'] = self::generateRandomString(3);
        $orderAddress['BVRVADDDATE'] = self::generateRandomString(8);
        ...
        $orderAddress['BVEXAMTKEY1'] = self::generateRandomNumber(8);
        $orderAddress['BVEXAMTKEY2'] = self::generateRandomNumber(8);
        $orderAddress['BVEXAMTFIELD1'] = self::generateRandomNumber(8);
        $orderAddress['BVEXAMTFIELD2'] = self::generateRandomNumber(8);
        $orderAddress['BVEXPRICEKEY1'] = self::generateRandomNumber(8);
        $orderAddress['BVEXPRICEKEY2'] = self::generateRandomNumber(8);
        $orderAddress['BVEXPRICEFIELD1'] = self::generateRandomNumber(8);
        $orderAddress['BVEXPRICEFIELD2'] = self::generateRandomNumber(8);
...
//        $record['NUMBER'] = '';
        ...
        $record['CUST_NO'] = self::generateRandomString(20);
        $record['CUST_NAME'] = self::generateRandomString(60);
        $record['CUST_PO_NO'] = self::generateRandomString(20);
    ...
    {
        $data = rand(pow(10, $length - 1), pow(10, $length) - 1);
    ...
    {
        return number_format(rand(0, pow(10, $length) - 1) / pow(10, $length), $length - 2, '.', '');
    }
